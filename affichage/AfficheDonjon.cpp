...
void AfficheDonjonVisible(const vector<vector<bool>>& matrice_adjacence, int taille, int sortieX, int sortieY, loot** LootsMatrix, int joueur_x, int joueur_y, bool**& visibleMatrix) {
    vector<bool> vue = visibilite(matrice_adjacence, taille, joueur_x, joueur_y);
